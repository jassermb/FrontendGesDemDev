...
const Developmentpart1RequestDetails = ({ requestId }) => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `http://localhost:5000/api/demdev/demande1-developpement/${requestId}`
        );
...
export default Developmentpart1RequestDetails;
