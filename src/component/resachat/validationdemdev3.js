...
const DetailsDemandePartie3 = () => {
    ...
    const handleTakeCharge = async (isValid) => {
        try {
            ...
            await axios.put(`http://localhost:5000/api/users/validationresachat/${id_demdev}`, { Validationresachat: validationStatus, status });
...
export default DetailsDemandePartie3;
